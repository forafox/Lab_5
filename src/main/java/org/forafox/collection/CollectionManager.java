package org.forafox.collection;
...
public class CollectionManager {
    ...
    public void show() {
        if (treeMap.size() == 0) {
            ...
            for (Map.Entry<Integer, LabWork> entry : treeMap.entrySet()) {
                System.out.println(entry.getValue().toString()); // перебор элементов коллкции
    ...
    public void showDifficult(){
        if (treeMap.size() == 0) {
            ...
            for (Map.Entry<Integer, LabWork> entry : treeMap.entrySet()) {
                System.out.println(entry.getValue().getDifficulty()); // перебор элементов коллкции
            } //Получение значений по коллекции
        }
    }
     ...
     */
    public void GroupCountingByDifficult(){
        ...
        System.out.println("Кол-во элементов co значением поля Difficult: \nVERY_EASY - "+countVERY_EASY+"\nEASY - "+countEASY+"\n" +
     ...
     */
    public void insert(Integer id, LabWork labWork) {
