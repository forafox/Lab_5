...
import org.forafox.exceptions.RecoursiveCallException;
...
public class ExecuteScriptCommand implements CommandWithArguments {
     ...
     */
    public ExecuteScriptCommand(CollectionManager collectionManager, LabWorkFieldsReader labWorkFieldsReader, Script script) {
